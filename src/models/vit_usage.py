# Script 2: Load saved model, mappings, and other models; process image
...
food_processor = AutoImageProcessor.from_pretrained("models/food_finetune/best_model")
food_model = AutoModelForImageClassification.from_pretrained("models/food_finetune/best_model")
...
with open("models/food_finetune/mappings.json", "r") as f:
...
# Example usage
result = process_image("src/models/test_images/my_test_folder/image1.jpg")
print(result)
result = process_image("src/models/test_images/my_test_folder/image2.jpg")
print(result)
result = process_image("src/models/test_images/my_test_folder/image3.jpg")
print(result)
result = process_image("src/models/test_images/my_test_folder/image4.jpg")
print(result)
result = process_image("src/models/test_images/my_test_folder/image5.jpg")
print(result)
result = process_image("src/models/test_images/my_test_folder/image6.jpg")
print(result)
result = process_image("src/models/test_images/my_test_folder/image7.jpg")
print(result)
result = process_image("src/models/test_images/my_test_folder/image8.jpg")
print(result)
result = process_image("src/models/test_images/my_test_folder/image9.jpg")
print(result)
result = process_image("src/models/test_images/my_test_folder/image10.jpg")
print(result)
result = process_image("src/models/test_images/my_test_folder/image11.jpg")
print(result)