...
training_args = TrainingArguments(
    output_dir="models/food_finetune",
    num_train_epochs=5,
...
trainer.save_model("models/food_finetune/best_model")
food_processor.save_pretrained("models/food_finetune/best_model")

# Save mappings to JSON
with open("models/food_finetune/mappings.json", "w") as f:
    json.dump({
